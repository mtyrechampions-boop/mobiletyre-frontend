export const locations = [
   ...
   { name: 'Eton', region: 'Berkshire', postcode: 'SL4', status: 'Operational' },
   ...
   { name: 'Hungerford', region: 'Berkshire', postcode: 'RG17', status: 'Operational' },
   { name: 'Langley', region: 'Berkshire', postcode: 'SL3', status: 'Operational' },
   ...
   { name: 'Maidenhead', region: 'Berkshire', postcode: 'SL6', status: 'Operational' },
   { name: 'Midhurst', region: 'West Sussex', postcode: 'GU29', status: 'Operational' },
   { name: 'Newbury', region: 'Berkshire', postcode: 'RG14', status: 'Operational' },
   ...
   { name: 'Slough', region: 'Berkshire', postcode: 'SL1', status: 'Operational' },
   ...
   { name: 'Sunningdale', region: 'Berkshire', postcode: 'SL5', status: 'Operational' },
   { name: 'Thatcham', region: 'Berkshire', postcode: 'RG18', status: 'Operational' },
   { name: 'Tongham', region: 'Surrey', postcode: 'GU10', status: 'Operational' },
   { name: 'Twyford', region: 'Berkshire', postcode: 'RG10', status: 'Operational' },
   ...
   { name: 'Windsor', region: 'Berkshire', postcode: 'SL4', status: 'Operational' },
