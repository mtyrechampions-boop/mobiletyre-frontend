    ...
    <section className="bg-gradient-to-br from-[#0B1528] via-[#0D1D3A] to-[#0B1528] py-20 md:py-28 px-4 md:px-10 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="flex flex-col sm:flex-row justify-center items-center gap-6">
          ...
          <a href="https://wa.me/447494024653" target="_blank" rel="noopener noreferrer" className="w-full sm:w-auto flex items-center justify-center gap-3 bg-white hover:bg-slate-100 text-slate-900 px-10 py-5 rounded-2xl font-bold tracking-wide transition-all shadow-[0_10px_30px_rgba(255,255,255,0.15)] active:scale-95">
